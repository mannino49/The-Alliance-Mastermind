...
export default function StephanieDashboard() {
  ...
  const weeklyData = {
    missionAlignment: [45, 48, 52, 50, 60],
    flowReadiness: [55, 58, 62, 60, 70],
    flowLeadership: [50, 52, 55, 55, 65]
  };
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-dark-800 p-6 rounded-xl shadow-xl">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <TrendIndicator trend="improving" note="direction sharpening" />
          </div>
          <Sparkline data={weeklyData.missionAlignment} />
          <p className="mt-4 text-gray-300">
            60% of time advancing chosen strategic next step. Clear MTP around wellbeing, flow, and leadership with meaningful refinement - letting go of guilt around downtime, exploring academic pathways while piloting talks and workshops.
          </p>
        </div>
      ...
      <div className="bg-dark-800 p-6 rounded-xl shadow-xl">
        ...
        <div className="prose max-w-none">
          <p>
            Stephanie continues to hold a clear MTP around wellbeing, flow, and leadership, but the past two months show meaningful refinement. She is letting go of guilt/shame around downtime and summer chaos, trusting that September will bring structure and acceleration.
          </p>
          <p className="mt-4">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-800">
                <td className="py-3 px-4 text-gray-300">Stephanie Van Deynze-Snell</td>
