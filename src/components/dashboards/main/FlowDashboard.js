...
export default function FlowDashboard({ onClientSelect }) {
  ...
  const clients = [
    ...
    },
    {
      id: 'sandra',
      name: 'Sandra Ozols',
      missionAlignment: '65 (Advisory Model Validation)',
      flowReadiness: 70,
      flowLeadershipLeverage: 65,
      topStrengths: 'Deep HR/organizational expertise, execution discipline, openness to AI tools',
      keyRisks: 'Overfocus on infrastructure, fear of irrelevance, thin external network',
      nextAction: 'Draft AI/org design white paper; test 3-5 advisory prototypes; engage Alliance + KKR portfolio for warm intros; set daily/weekly market-facing action quota',
      trend: {
        missionAlignment: 'improving',
        flowReadiness: 'improving',
        flowLeadership: 'improving'
